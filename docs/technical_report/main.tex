...
\begin{itemize}
    ...
    \item \textbf{68/68 tests passing} (100\% coverage) with full reproducibility
\end{itemize}
...
\begin{enumerate}
    \item Google Quantum AI. "Suppressing quantum errors by scaling a surface code logical qubit." \textit{Nature} (2025).
    \item Gidney, C. "Stim: a fast stabilizer circuit simulator." \textit{Quantum} 5, 497 (2021).
    \item Higgott, O. "PyMatching: A Python package for decoding quantum codes with minimum-weight perfect matching." (2021).
\end{enumerate}

...
\caption{Feedback controller dynamics during drift suppression. Top: syndrome density over time with step drift injection. Bottom: controller correction signal showing integral accumulation and settling behavior.}
\label{fig:feedback}
\end{figure}
...
For our default parameters ($K_i = 0.05$, latency $= 500$ ns):
\begin{itemize}[noitemsep]

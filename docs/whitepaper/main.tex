...
\textbf{L3. Configurable Feedback Latency (NEW)}: Realistic FPGA latency (100--600ns) is now modeled via \texttt{latency\_ns} parameter with T1/T2 decay during idle. 6 new tests validate this feature.
